...
sqlite_exec($sql, "CREATE TABLE amxxversions (ID INTEGER PRIMARY KEY, Name TEXT, Folder TEXT, Display INTEGER)");
sqlite_exec($sql, "INSERT INTO amxxversions VALUES(NULL, '', '', NULL);");
sqlite_exec($sql, "CREATE TABLE smversions (ID INTEGER PRIMARY KEY, Name TEXT, Folder TEXT, Display INTEGER)");
sqlite_exec($sql, "INSERT INTO smversions VALUES(NULL, '', '', NULL);");
